                        ...
                        <table class="w-full text-md bg-white shadow-md rounded mb-4">
                            <tbody>
                                ...
                                <tr class="border-b hover:bg-orange-100 bg-gray-100">
                                    ...
                                    <td class="p-3 px-5 flex justify-end"><a href="{{ route('admin.validate.edit', $surat->id) }}" type="button" class="mr-3 text-sm bg-blue-500 hover:bg-blue-700 text-white py-1 px-2 rounded focus:outline-none focus:shadow-outline">Validasi</a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
